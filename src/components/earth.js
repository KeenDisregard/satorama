...
class Earth {
  ...
  createEarth() {
    ...
    const material = new THREE.MeshPhongMaterial({
      map: new THREE.TextureLoader().load('/assets/textures/earth-blue-marble.jpg'),
      bumpMap: new THREE.TextureLoader().load('/assets/textures/earth-topology.png'),
      bumpScale: 100,
      specularMap: new THREE.TextureLoader().load('/assets/textures/earth-water.png'),
